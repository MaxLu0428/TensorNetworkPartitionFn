...
makeFolder(FILE)
FILE2 = './transfer_matrix_rescaleFactor/'
makeFolder(FILE2)
...
for i,T in enumerate(T_list):
    ...
    SAVE_dATA(eigenvalues,trgstep,EigVnums,dcut,FILE+'eigenvalue_T'+str(T)+'_D'+str(dcut)+'.csv' )
SAVE_dATA2(scaleFactors,T_list,1+trgstep,dcut,FILE2+'normalization1_T'+str(T)+'_D'+str(dcut)+'.csv' )
